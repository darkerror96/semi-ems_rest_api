...
//		Employee e2 = new Employee("Brad Daniel", 22, 1, 1010101010, a2, a2, 222222222, "braddaniel@colla.com", 1, 1,
//				2222, 5, 0);
...
//		Employee e1 = new Employee("Tom Wall", 18, 1, 1212121212, a1, a1, 111111111, "tomwall@colla.com", 1, 1, 1111, 4,
//				0);
//		ObjectMapper objMapper = new ObjectMapper();
//
...
//		mockMvc.perform(delete("/employee/delete?empId=7")).andExpect(status().isOk());
//	}
//
//	@Test
//	public void testGetManId() throws Exception {
//		Address a4 = new Address("33 Ema", "Auth St", "New Jersey", "USA", 72374);
//		Employee m1 = new Employee("Jason Torres", 38, 1, 1818181818, a4, a4, 444444444, "jasontorres@colla.com", 2, 2,
//				1999, 0, 1);
//		ObjectMapper objMapper = new ObjectMapper();
//
...
//		mockMvc.perform(delete("/manager/delete?manId=16")).andExpect(status().isOk());
//	}
}
